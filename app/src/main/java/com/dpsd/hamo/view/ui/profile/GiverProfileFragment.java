...
import com.dpsd.hamo.databinding.FragmentGiverProfileBinding;
...
public class GiverProfileFragment extends Fragment implements Updater
{
    ...
    private @NonNull
    FragmentGiverProfileBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState)
    {
        binding = FragmentGiverProfileBinding.inflate(inflater, container, false);
